 ...
 */
final class Version20230124090809 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_recipie (category_id INT NOT NULL, recipie_id INT NOT NULL, INDEX IDX_3CD0589612469DE2 (category_id), INDEX IDX_3CD058964D7054B8 (recipie_id), PRIMARY KEY(category_id, recipie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
