...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Recipie::class)]
    ...
    public function addRecipy(Recipie $recipy): self
    {
    ...
    public function removeRecipy(Recipie $recipy): self
    {
        if ($this->recipies->removeElement($recipy)) {
            // set the owning side to null (unless already changed)
            if ($recipy->getUser() === $this) {
                $recipy->setUser(null);
            }
        }
